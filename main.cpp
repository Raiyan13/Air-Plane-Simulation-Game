...
void display()
{
	...
	else if (instflag == true)
	{
		...
		drawString(23,41,0,GLUT_BITMAP_HELVETICA_18,"    traveled,NITROS left,Altitude and the LEVEL.");
	...
	else if (abtflag == true)
	{
		...
		drawString(21,61,0,GLUT_BITMAP_HELVETICA_18,"            This is a simulation game");
...
void keyPressed(unsigned char key,int x, int y) // int x and y are mouse position at time of press
{
	if(key == 'e')
	{
		exit(0);
